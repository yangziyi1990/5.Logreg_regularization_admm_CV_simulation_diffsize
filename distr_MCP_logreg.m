function [z, history] = distr_MCP_logreg(A, b, mu, N, rho, alpha, n1, n2, n3)

% distr_MCP_logreg   Solve distributed MCP regularized logistic regression
%
% [x, history] = distr_MCP_logreg(A, b, mu, N, rho, alpha)
%
...
%
% This solves the MCP regularized logistic regression problem. It uses
% a custom Newton solver for the x-step. This version solves a distributed
% version of MCP regularized logistic regression.
%
