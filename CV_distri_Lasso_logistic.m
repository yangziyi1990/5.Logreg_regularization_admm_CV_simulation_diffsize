function [Opt,Mse]=CV_distri_Lasso_logistic(X, Y, Lambda, J, beta_int, beta_zero, n1, n2, n3)
    ...
    for l=1:length(Lambda)
        ...
        for i=1:K
            ...
            [b history] = distr_l1_logreg(X_train, Y_train, lambda, J, 1.0, 1.0, num1, num2, num3);
